...
describe.skip('entire voter flow using OTP authorization', function () {
    var sandbox;
    beforeEach(function () {
    ...
    it('returns a receipt', function () { return __awaiter(void 0, void 0, void 0, function () {
        var client, voterId, voterEmail, oneTimePassword, _confirmationToken, contestConfigs, ballotConfig, ballotSelection, _trackingCode, affidavit, receipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = new av_client_1.AVClient(test_helpers_1.bulletinBoardHost + 'us');
                ...
                case 6:
                    _trackingCode = _a.sent();
                    affidavit = Buffer.from('some bytes, most likely as binary PDF').toString('base64');
                    return [4 /*yield*/, client.castBallot(affidavit)];
                case 7:
                    receipt = _a.sent();
                    (0, chai_1.expect)(receipt.trackingCode.length).to.eql(7);
                    return [2 /*return*/];
            }
        });
    }); }).timeout(10000);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, axios_1.default.get("".concat(test_helpers_1.mailcatcherHost, "messages"))
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.get("".concat(test_helpers_1.mailcatcherHost, "messages/").concat(lastMessageId, ".plain"))
                                .then(function (response) { return response.data; })];
                    case 3:
                        message = _a.sent();
                        otpPattern = /\d{5}/g;
...
describe.skip('entire voter flow using PoEC authorization', function () {
    var sandbox;
    beforeEach(function () {
        sandbox = (0, test_helpers_1.resetDeterminism)();
    });
    ...
    it('returns a receipt', function () { return __awaiter(void 0, void 0, void 0, function () {
        var client, contestConfigs, ballotConfig, ballotSelection, _trackingCode, affidavit, receipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = new av_client_1.AVClient(test_helpers_1.bulletinBoardHost + '2904b00f_5abcbf894df3_58');
                    return [4 /*yield*/, client.initialize(undefined, {
                            privateKey: 'bcafc67ca4af6b462f60d494adb675d8b1cf57b16dfd8d110bbc2453709999b0',
                            publicKey: '03b87d7fe793a621df27f44c20f460ff711d55545c58729f20b3fb6e871c53c49c'
                        })];
