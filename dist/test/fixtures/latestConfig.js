...
var itemHelper_1 = require("./itemHelper");
var latestConfig = {
    items: {
        thresholdConfig: __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'ThresholdConfigItem', content: {
                encryptionKey: "03d8c46ae42cd7f95009ddf444eebc5b18e2cad34aad94129ffc54b5606b5638f4",
                threshold: 1,
                trustees: []
            } }),
        voterAuthorizerConfig: __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'VoterAuthorizationConfigItem', content: {
                identityProvider: {
        ...
        ballotConfigs: {
            precinct_4_bedrock: __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'BallotConfigItem', content: {
        ...
        contestConfigs: {
            "contest ref 1": __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'ContestConfigItem', content: {
            ...
            "contest ref 2": __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'ContestConfigItem', content: {
        ...
        electionConfig: __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'ElectionConfigItem', content: {
                title: {
                    en: "Some US Election"
                },
        ...
        votingRoundConfigs: {
            "voting-round-1": __assign(__assign({}, (0, itemHelper_1.baseItemAttributes)()), { type: 'VotingRoundConfigItem', content: {
                    status: "open",
...
exports.default = latestConfig;
//# sourceMappingURL=latestConfig.js.map