 ...
 * ```
 */
export declare type BallotBoxReceipt = {
    trackingCode: string;
    receipt: {
        address: string;
        dbbSignature: string;
...
export declare type BoardItem = VoterSessionItem | VoterCommitmentItem | BoardCommitmentItem | BallotCryptogramItem;
export declare type BoardItemType = "BallotCryptogramsItem" | "BoardEncryptionCommitmentItem" | "CastRequestItem" | "SpoilRequestItem" | "VerificationStartItem" | "VerifierItem" | "VoterEncryptionCommitmentItem" | "VoterSessionItem" | "VoterEncryptionCommitmentOpeningItem";
...
export declare type EncryptedCommitmentOpening = string;
...
export declare type BallotStatus = {
    status: string;
    activities: {
        type: string;
...
export declare type BallotSelection = {
    reference: string;
    contestSelections: ContestSelection[];
};
export declare type ContestSelection = {
    reference: string;
    piles: SelectionPile[];
};
export declare type SelectionPile = {
    multiplier: number;
    optionSelections: OptionSelection[];
};
export declare type OptionSelection = {
    reference: string;
    text?: string;
};
export declare type ContestEnvelope = {
    reference: string;
    piles: EncryptedPile[];
};
export declare type ReadableContestSelection = {
    reference: string;
    title: string;
    piles: ReadableSelectionPile[];
};
export declare type ReadableSelectionPile = {
    multiplier: number;
    optionSelections: ReadableOptionSelection[];
};
export declare type ReadableOptionSelection = {
    reference: string;
    title: string;
    text?: string;
};
...
export interface LatestConfigurationConfig extends BaseBoardItem {
    type: 'ThresholdConfigItem' | 'VoterAuthorizationConfigItem' | 'BallotConfigItem' | 'ContestConfigItem' | 'VotingRoundConfigItem' | 'ElectionConfigItem' | 'GenesisItem' | 'SegmentsConfigItem';
    content: VoterAuthorizerContent | ThresholdConfigContent | BallotContent | ContestContent | VotingRoundContent | ElectionConfigContent | GenesisConfigContent | SegmentsConfigContent;
}
